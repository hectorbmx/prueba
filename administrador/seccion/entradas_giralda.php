...
switch($accion){
    ...
    case "agregar":
         ...
         else { $sql=$conexion->prepare ("INSERT INTO entradas_almacen (id_producto,cantidad,costo,factura,fecha)
...
<h1>Lista de entradas y salidas de almacen</h1><br>
<button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ModalNuevo">Agregar entrada:</button>
<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ModalNuevo">Agregar salida:</button>
