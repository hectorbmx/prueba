...
switch($accion){
    ...
    case "agregar":
                    ...
                    $sql=$conexion->prepare ("INSERT INTO gastosgiralda (id_factura,fecha_factura,proveedor,concepto,cantidad,costosiva,total,fecha_registro)
                                                    VALUES (:id_factura,:fecha_factura,:proveedor,:concepto,:cantidad,:costosiva,:total,:fecha_registro)");
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post"  enctype= multipart/form-data">
                ...
                <div class="form-floating mb-3">
                <!-- <input type="text" name="fecha_factura" id="fecha_factura" class="form-control" placeholder=""required />  -->
                <label for="validationCustom03" class="form-label">Fecha de la factura:</label><br>
                <input type="date" class="form-control" id="datepicker" id="fecha_factura" name ="fecha_factura" value="<?php echo $txtFechaNac; ?>"required>
                </div>
                <div class="form-floating mb-3">
...
<?php if (isset($mensaje)){?>
        ...
        <?php foreach ($empleados as $result) {?>
            <tr>
                ...
                <td><?PHP echo $result ['fecha_factura'];?></td>
