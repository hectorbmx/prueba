...
//CONFIGURAR ESTE ESPACIO
	...
	$basededatos = "riveraco1";   // Nombre de la base de datos (¡Las mayusculas IMPORTAN!)
	$usuariodb 	 = "root";    		// Nombre del usuario administrador de la base de datos
	$clavedb 	 = "admin";    			// Clave para acceder a la base de datos.

	//LISTA DE TABLAS
	$tabla_db1 = "gastos_obras"; 	   			
	$tabla_db2 = "empleados"; 
	$tabla_db3 = "gastos_obras"; 
